...
export default function AdminDashboard() {
  ...
  return (
    <DashboardShell roleTitle="Platform Admin" roleBadgeColor="var(--color-ember)">
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', paddingTop: '40px' }}>
        <div
          style={{
            ...
            height: '64px',
            borderRadius: '16px',
            background: 'rgba(216,92,63,0.15)',
        ...
        <p style={{ fontSize: '18px', color: 'var(--color-ink-muted)', marginBottom: '36px' }}>
          Welcome, <strong>{user?.name || 'Administrator'}</strong>. Platform administration privileges verified.
        </p>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px' }}>
            <div>
              <div style={{ fontSize: '12px', color: 'var(--color-ink-muted)' }}>Admin Name</div>
              <div style={{ fontSize: '15px', fontWeight: '600', color: 'var(--color-ink)', marginTop: '2px' }}>{user?.name}</div>
            </div>
            <div>
              <div style={{ fontSize: '12px', color: 'var(--color-ink-muted)' }}>Admin Email</div>
            ...
            <div>
              ...
              <div style={{ fontSize: '15px', fontWeight: '600', color: 'var(--color-ink)', marginTop: '2px', textTransform: 'uppercase' }}>{user?.role}</div>
            </div>
            <div>
